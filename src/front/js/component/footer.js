    ...
    <div className="d-flex justify-content-center">
      <div className="row">
        <div className="col-lg-3 col-md-4 col-sm-6">
          ...
          <p className="text-secondary">Values</p>
        </div>
        <div className="col-lg-3 col-md-4 col-sm-6">
          <ul className="d-none d-sm-block">
            <li>
              <h5 className="mb-4 d-none d-sm-block">Home</h5>
            </li>
            <li>
              <p className="text-secondary">Movies</p>
              <p className="text-secondary">Find your perfect movie</p>
              <p className="text-secondary">Your Watchlist</p>
            </li>
          </ul>
        </div>
        <div className="col-sm-6 col-md-4 col-lg-3 d-none d-sm-block">
          <h5 className="mb-4">Terms of Use</h5>
          <p className="text-secondary">Privacy policy</p>
        </div>
        <div className="col-sm-6 col-md-4 col-lg-3">
          <h5 className="mb-4">Support</h5>
          <p className="text-secondary">ScreeneR@movies.com</p>
        </div>
      </div>
    </div>
  </footer>
